...
<div style="text-align:center">
    ...
    <form action="LastpageServlet" method="post">
        ...
        <input type="text" id="cname" name="cname" size="30" maxlength="30" pattern="([A-Za-z\s]{3,})" title="Surname whitespace familiename" placeholder="Kreditkarteninhalter/-in" required><br><br>
        ...
        <div style="text-indent:-102px">
            ...
            <input type="text" id="date" name="date" size="5" maxlength="5" pattern="^(0[1-9]|1[0-2])[\/]{1}?([0-9]{2})$" title="Last 2 digits of the month and of the year." placeholder="MM/YY" required ><br><br>
