...
<div style="text-align:center">
    ...
    <form action="FirstpageServlet" method="post">
        ...
        <div style="text-indent:-100px">
            ...
            <input type="text" size="20" maxlength="20" id="name" name="name" pattern="[a-z]{3,}2s" title="Beispiel: aabusa2s" required/><br><br>
        ...
        <div style="text-indent:-68px">
            ...
            <input type="password" size="20" maxlength="20" id="pword" name="pword" pattern="[a-zA-Z0-9]{7}" title="SE1 App password" placeholder="Enter SE1 App password" required/><br><br>
